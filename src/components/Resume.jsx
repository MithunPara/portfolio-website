      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-secondary/15 flex-shrink-0">
              <IoDocumentTextOutline className="h-7 w-7 text-accent" />
            </div>

            <div className="flex-1 space-y-2">
              <h3 className="text-2xl font-semibold">Mithun Paramathasan</h3>
